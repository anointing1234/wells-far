(function ($) {
  ...
  function dynamicCurrentMenuClass(selector) {
    ...
    // Get clean current path (no query string, no hash)
    ...
    selector.find("li").each(function () {
        ...
        let linkPath = anchor.attr("href").replace(/\/$/, "");
    ...
    // If any child li is current, mark parent li as current
    selector.find("li").each(function () {
    ...
    // Default to first menu item if homepage
    if (currentPath === "") {
